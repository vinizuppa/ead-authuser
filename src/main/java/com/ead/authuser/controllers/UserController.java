...
import com.ead.authuser.configs.security.UserDetailsImp;
...
public class UserController {
    ...
    public ResponseEntity<Page<UserModel>> getAllUsers(SpecificationTemplate.UserSpec spec,
        ...
        UserDetails userDetails = (UserDetailsImp) authentication.getPrincipal();//Extraimos "principal"
    ...
    public ResponseEntity<Object> getOneUser(@PathVariable(value = "userId")UUID userId){
        UUID currentUserId = authenticationCurrentUserService.getCurrentUser().getUserId();//Extrai Id do usuário que está realizando a requisição.
        if (currentUserId.equals(userId)){//Se o Id do usuário que fez a requisição for igual ao id do usuário que veio na url
