...
public class UserModel extends RepresentationModel<UserModel> implements Serializable {
    ...
    @OneToMany(mappedBy = "user", fetch = FetchType.LAZY)//Um userModel para multiplos userCoursesModels
    private Set<UserCourseModel> usersCourses;//Coleção de UserCourses.

    public UserCourseModel convertToUserCourseModel(UUID couserId){
        return new UserCourseModel(null, couserId, this);
    }
}
